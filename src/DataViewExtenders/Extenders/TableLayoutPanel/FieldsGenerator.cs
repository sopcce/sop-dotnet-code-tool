...
namespace CBComponents.Extenders.TableLayoutPanel
{
    public static partial class TableLayoutPanelExtenders
  {
    ...
    public static void GenerateFields(this System.Windows.Forms.TableLayoutPanel dataPanel, object DataSource, params FieldDataDescriptor[] Fields)
    {
    ...
    /// <param name="DataSource">Data Source to support data-binding</param>
    /// <param name="Fields">Field data descriptors</param>
    public static void GenerateFields(this System.Windows.Forms.TableLayoutPanel dataPanel, ToolTip toolTip, object DataSource, params FieldDataDescriptor[] Fields)
    {
      ...
      foreach (var field in Fields)
      {
        ...
        else if (field.Mode == FieldEditorMode.ListBox)
        {
          ...
          {
            var _pnl = new System.Windows.Forms.TableLayoutPanel();
            _pnl.AutoSize = true;
